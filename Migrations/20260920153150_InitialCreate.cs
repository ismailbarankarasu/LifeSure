        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Message = table.Column<string>(type: "nvarchar(max)", maxLength: 6000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ContactMessages_Status", "[Status] IN (0, 1, 2)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapUrl = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ButtonUrl = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Statistics_Source", "[Source] IN (0, 1, 2)");
                    table.CheckConstraint("CK_Statistics_Value", "[Value] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Answer = table.Column<string>(type: "nvarchar(max)", maxLength: 6000, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LanguageCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    FooterDescription = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeatureTranslations_FeatureId_LanguageCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatisticTranslations_StatisticId_LanguageCode",
                table: "StatisticTranslations",
                columns: new[] { "StatisticId", "LanguageCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TeamMemberTranslations_TeamMemberId_LanguageCode",
                table: "TeamMemberTranslations",
                columns: new[] { "TeamMemberId", "LanguageCode" },
                unique: true);
